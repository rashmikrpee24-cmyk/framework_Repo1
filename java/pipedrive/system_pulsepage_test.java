...
public class system_pulsepage_test {
		    public static void main(String[] args) throws Exception {
		        ...
		        Thread.sleep(2000);
		        driver.findElement(By.xpath("//ul[@class='fe-root-side-menu fe-root-side-menu--lastItemBorder-bottom fs-unmask']/descendant::a[3]")).click();

		        driver.findElement(By.xpath("//ul[@class='fe-root-secondary-menu__items']//descendant::a[2]")).click();
